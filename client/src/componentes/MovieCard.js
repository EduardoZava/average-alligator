...
function MovieCard({ movie, editMovie, deleteMovie }) {
    ...
    return (
        ...
        >
            <div className='text-titulo-center'> {/* Centraliza o título do catálogo */}
                <h1 className="text-3xl ">Catálogo de Filmes</h1>
            </div>
            {/* IMAGEM DO PÔSTER */}
            <div className="flex-shrink-poster "> {/* Contêiner para a imagem, centralizado */}
                <img 
                    src={movie.poster} 
            ...
            <div className="flex-grow flex flex-col min-h-0"> 
                ...
                <h3 className="text-3xl">{movie.title} ({movie.year})</h3>
